...
function createTaskAccordion(aName, aDesc, aDate, aPrio, aProject, aId, aPrioColor) {
    ...
    taskAccordion.style = `--bs-accordion-border-color: ${aPrioColor};`
            ...
            <h2 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#accordion-${aId}" aria-expanded="true" aria-controls="collapseOne">
                    ...
                    <div class="task-buttons">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" class="bi bi-pencil-square task-edit" data-bs-toggle="modal" data-bs-target="#exampleModal" name="${aName}" desc="${aDesc}" date="${aDate}" prio="${aPrio}" project="${aProject}" id=${aId} viewBox="0 0 16 16">
                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                        </svg>
                    
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="red" class="bi bi-trash3 task-trash" id=${aId} viewBox="0 0 16 16">
    ...
    // taskList.appendChild(taskAccordion);
